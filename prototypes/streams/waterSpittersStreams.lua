data:extend{
    ...
    {
		type = "stream",
		name = "small-water-spitter-stream",
		flags = { "not-on-map" },
		...
		{
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "create-fire",
							entity_name = "small-water-spitter-fire",
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = damage_modifier_spitter_small * 0.65, type = "water" }
						}
					}
				}
			},
			{
				type = "area",
				radius = stream_radius_spitter_small * 2,
				force = "ally",
				ignore_collision_condition = true,
				action_delivery =
				{
					...
					{
						type = "damage",
						damage = { amount = -_CONFIG.biters.water.small_spitter_impact_healing, type = "water" }
					}
				}
			}
		},
	...
	{
		type = "stream",
		name = "medium-water-spitter-stream",
		flags = { "not-on-map" },
		particle_buffer_size = 90,
		particle_spawn_interval = 1,
		particle_spawn_timeout = 6,
		...
		{
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "create-fire",
							entity_name = "medium-water-spitter-fire",
							tile_collision_mask = { "water-tile" },
							show_in_tooltip = true
						},
						{
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = damage_modifier_spitter_medium * 0.65, type = "water" }
						}
					}
				}
			},
			{
				type = "area",
				radius = stream_radius_spitter_medium * 2,
				force = "ally",
				ignore_collision_condition = true,
				action_delivery =
				{
					...
					{
						type = "damage",
						damage = { amount = -_CONFIG.biters.water.medium_spitter_impact_healing, type = "water" }
					}
				}
			}
		},
		...
		{
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "create-fire",
							entity_name = "big-water-spitter-fire",
							tile_collision_mask = { "water-tile" },
							show_in_tooltip = true
						},
						{
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = damage_modifier_spitter_big * 0.65, type = "water" }
						}
					}
				}
			},
			{
				type = "area",
				radius = stream_radius_spitter_big * 2,
				force = "ally",
				ignore_collision_condition = true,
				action_delivery =
				{
					...
					{
						type = "damage",
						damage = { amount = -_CONFIG.biters.water.big_spitter_impact_healing, type = "water" }
					}
				}
			}
		},
	...
	{
		type = "stream",
		name = "behemoth-water-spitter-stream",
		flags = { "not-on-map" },
		particle_buffer_size = 90,
		particle_spawn_interval = 1,
		particle_spawn_timeout = 6,
		...
		{
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "create-fire",
							entity_name = "behemoth-water-spitter-fire",
							tile_collision_mask = { "water-tile" },
							show_in_tooltip = true
						},
						{
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = damage_modifier_spitter_behemoth * 0.65, type = "water" }
						}
					}
				}
			},
			{
				type = "area",
				radius = stream_radius_spitter_behemoth * 2,
				force = "ally",
				ignore_collision_condition = true,
				action_delivery =
				{
					...
					{
						type = "damage",
						damage = { amount = -_CONFIG.biters.water.behemoth_spitter_impact_healing, type = "water" }
					}
				}
			}
		},

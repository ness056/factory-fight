			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.small_biter_damage * 0.35, type = "acid" }
						},
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.small_biter_damage * 0.65, type = "neutral" }
						}
					}
				}
			}
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.medium_biter_damage * 0.35, type = "acid" }
						},
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.medium_biter_damage * 0.65, type = "neutral" }
						}
					}
				}
			}
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.big_biter_damage * 0.35, type = "acid" }
						},
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.big_biter_damage * 0.65, type = "neutral" }
						}
					}
				}
			}
			...
			},
			{
				...
				action_delivery =
				{
					...
					target_effects =
					{
						...
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.behemoth_biter_damage * 0.35, type = "acid" }
						},
						{
							type = "damage",
							damage = { amount = _CONFIG.biters.neutral.behemoth_biter_damage * 0.65, type = "neutral" }
						}
					}
				}
			}
